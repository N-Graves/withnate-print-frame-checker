...
const result = await build({
  ...
  outfile: "dist/print-frame-checker.js",
  bundle: true,
  format: "iife",
  target: "es2020",
  platform: "browser",
...
await build({
  ...
  outfile: "dist/print-frame-checker.css",
  bundle: true,
  minify: false,
  banner: { css: banner },
});

const out = result.metafile.outputs["dist/print-frame-checker.js"];
const css = await readFile(new URL("../dist/print-frame-checker.css", import.meta.url));
